...
#define USER_PROCESS_1_TABLE_START_WRITABLE 0xFFFF000080A00000UL
#define USER_PROCESS_1_TABLE_START 0x80A00000UL
#define USER_PROCESS_2_TABLE_START (USER_PROCESS_1_TABLE_START + 0x00060000UL)
#define USER_PROCESS_2_TABLE_START_WRITABLE (USER_PROCESS_1_TABLE_START_WRITABLE + 0x00060000UL)
